...
Ny = 500;
Nz = 500;
[y,z] = meshgrid(linspace(-0.4, 0.4, Ny), linspace(0, 0.4, Nz));
...
%% ===================== 2. 显示火焰辐射图 =====================
figure('Color','white');
imagesc(linspace(-0.2, 0.2, Ny), linspace(0, 0.4, Nz), I);
set(gca, 'YDir', 'normal');
colormap(hot(256));
...
for k = 1:3
    fprintf('正在计算第 %d 个通道...\n', k);
    obje = double(obj(:,:,k));
   obj_w = 0.60 * 1000;   % 横向物理宽度，0.08 m = 80 mm
obj_h = 0.90 * 1000;   % 纵向物理高度，0.40 m = 400 mm
